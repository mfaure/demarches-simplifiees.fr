    ...
    describe 'draft_revision' do
      ...
      context 'on publish' do
        it 'validates that no repetition type de champ is empty' do
          ...
          expect(draft_procedure.errors[:draft_revision]).to include("Champs : le bloc répétable est vide")
          ...
          draft_procedure.validate(:publication)
          expect(draft_procedure.errors[:draft_revision]).not_to include("Champs : le bloc répétable est vide")
        end
      end
